        ...
        <div v-else class="w-full pt-[200px]">
            <div class="mx-auto w-[60%] max-sm:w-[90%] border dark:border-zinc-700 bg-gray-100 dark:bg-zinc-800 shadow-md p-5 text-sm leading-6"
                ...
                <div
                    ...
                    <div class="flex gap-5">
                        ...
                        <span v-if="selectedPost?.showComments" class="flex gap-1">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24">
                                <path fill="currentColor"
                                    d="M6 14h12v-2H6zm0-3h12V9H6zm0-3h12V6H6zM2 18V2h20v20l-4-4z" />
                            </svg>
                ...
                <div class="post-footer flex flex-col gap-3 border-t border-zinc-300 dark:border-zinc-500 pt-3">
                    ...
                    <div v-if="selectedPost?.showTags" class="mt-1 flex flex-wrap gap-1">
                        <span v-for="tag in selectedPost?.tags" :key="tag"
                            class="p-1 border border-blue-900 rounded-md text-blue-900 cursor-pointer hover:bg-blue-900 hover:text-white dark:bg-zinc-600 dark:text-white dark:border-zinc-500 dark:hover:bg-white dark:hover:text-zinc-800 duration-200">
                            {{ tag }}
                        </span>
                    </div>

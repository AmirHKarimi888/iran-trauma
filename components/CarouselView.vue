<template>
    <div class="carousel m-auto lg:w-[60%] md:w-[80%] sm:w-[100%] max-sm:w-full py-2">
        <Carousel :value="carousel" :numVisible="1" :numScroll="1" circular :autoplayInterval="3000"
            :showIndicators="false">
            <template #item="slotProps">
                <div class="h-full border border-gray-300 dark:border-zinc-700 dark:border-surface-700 rounded p-4 bg-gray-100 dark:bg-zinc-800 shadow-md dark:shadow-none grid"
                    style="direction: rtl;">
                    <div>
